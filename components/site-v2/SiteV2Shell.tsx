...
export default function SiteV2Shell({ children }: { children: ReactNode }) {
  return (
    <div className={`${styles.siteV2Route} jjuSiteV2Route`}>
      ...
      <main id="site-v2-main" className={styles.siteMain}>{children}</main>
