...
const ROUTE_IDENTITIES: Array<{
  ...
  { href: "/admin/print", label: "Print Design Lab", description: "Design the physical series system", kind: "print" },
  { href: "/admin/narrators", label: "Narrator Room", description: "Assign and review narration work", kind: "audio" },
  { href: "/admin/audio", label: "Audio QA", description: "Listen to sealed audiobook editions", kind: "audio" },
