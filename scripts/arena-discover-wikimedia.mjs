...
function scoreCandidate(candidate) {
  ...
  if (text.includes("no text") || text.includes("unlabeled") || text.includes("without labels")) score += 24;
  if (text.includes("diagram") || text.includes("svg")) score += 12;
  if (text.includes("label")) score -= 18;
  if (text.includes("highlighted")) score -= 10;
  if (text.includes("section")) score += 6;
  if (text.includes("head") || text.includes("face") || text.includes("skull")) score -= 12;
  if (text.includes("photograph") || text.includes("autopsy") || text.includes("mri") || text.includes("ct ")) score -= 30;
  if (text.includes("watercolour") || text.includes("engraving") || text.includes("wellcome")) score -= 10;
  if (text.includes("cognitive science") || text.includes("heptagram")) score -= 60;
  if (text.includes("embryo") || text.includes("foetal") || text.includes("fetal")) score -= 40;
  if (text.includes("broca") || text.includes("wernicke")) score -= 30;
  if (text.includes("blausen")) score -= 36;
  if (text.includes("3d print") || text.includes("3dprinted") || text.includes("printed brain")) score -= 54;
  if (text.includes("dog") || text.includes("retina") || text.includes("sitnici") || text.includes("amentia")) score -= 44;
  if (title.includes("brain anatomy (sagittal)") || title.includes("capts") || title.includes("-en.")) score -= 54;
