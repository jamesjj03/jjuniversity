    ...
    <main className={styles.page}>
      ...
      <section className={styles.tools} aria-label="Editorial review tools">
        <article>
          ...
          <Link href={getAdminHref("/admin/manuscript-case")}>{caseReview.available ? "Open capitalization review" : "View local-only details"}</Link>
        </article>
        ...
        <article>
          ...
          <Link href={getAdminHref("/admin/taxonomy-review")}>Open sorting desk</Link>
        </article>
      </section>
    </main>
  );
